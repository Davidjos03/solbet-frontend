  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-card-color': 'linear-gradient(156deg, #545a65 4.8%, #242b4a 44.22%)',
        'gradient-card-border': 'linear-gradient(156deg, #57667F 4.8%, #37445C 44.22%)',
        ...
        'gradient-border-intro': 'linear-gradient(180deg, #09A0FC 40%, #2A62C1 60%)',
        'gradient-border-color-btn': 'linear-gradient(180deg, #5D82D0 0%, #4E70BA 100%)',
        'gradient-lucky-bg': 'linear-gradient(268deg, #12703b -80.56%, #1d2b45 50%)',
        'gradient-biggest-bg': 'linear-gradient(268deg, #705b12 -77.71%, #1d2b45 50%)',
