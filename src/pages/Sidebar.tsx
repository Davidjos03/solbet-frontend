...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col fixed left-0 top-[70px] lg:top-[110px] w-[350px] lg:w-[300px] 2xl:w-[350px] h-[calc(100%-70px)] lg:h-[calc(100%-110px)] bg-[#141414] border-r border-[#1D1D1D] z-[35] transition-transform duration-300 will-change-transform translate-x-0">
      <button className="group items-center justify-center min-w-10 overflow-hidden transition duration-300 px-4 bg-[#303030] hover:bg-[#393939]/75 text-sm font-medium text-white rounded-lg absolute top-3 -right-[56px] -z-[2] w-[56px] h-[56px] rounded-l-none border-r-[2px] border-[#3B3B3B] will-change-transform hidden md:block opacity-0 animate-fade-in -translate-x-[56px] cursor-pointer">
      </button>
      <div className="absolute w-full px-6 py-4 bg-[#141414] top-0 left-0 z-[10] grow-0 shrink-0 animate-fade-in">
        <div className="flex gap-2 mb-3">
          ...
          <button className="group flex items-center justify-center relative h-10 min-w-10 overflow-hidden transition duration-300 bg-[#303030] hover:bg-[#393939]/75 text-sm font-medium text-white rounded-lg w-max px-0 border border-[#3B3B3B] cursor-pointer">
