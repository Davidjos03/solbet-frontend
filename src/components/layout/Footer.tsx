...
const Footer = () => {
    return (
        <div className="w-full relative font-inter">
            <img src="/images/second.png" className="absolute -top-[360px] left-0 w-full h-[350px] -z-[100] bg-contain"></img>
            <div className="flex flex-col py-9 px-6 md:px-10 lg:px-16 pb-[100px] md:pb-9">
                <div className="flex w-full mx-auto bg-gradient-border-intro p-[2px] rounded-xl max-w-[1064px]">
                    <div className="flex flex-col md:flex-row items-center bg-[#0C1E3D] w-full h-full rounded-xl p-6 gap-6 text-center md:text-left">
                ...
                <div className="rounded-xl mx-auto border border-layer2 max-w-[1064px] mt-5">
                    <div className="rounded-xl bg-[#171D36]">
                        <div className="flex flex-row justify-center items-center py-4 px-6 gap-6">
                            ...
                            <p className="text-light-grey font-normal leading-[1.25rem] text-xs">
                ...
                <div className="flex flex-col 1.5xl:flex-row justify-between items-center mt-[42px] max-w-[1064px] mx-auto w-full gap-12">
                    ...
                    <div className="flex flex-col sm:justify-between sm:flex-row 1.5xl:px-0 px-8 gap-6 w-3/4 sm:w-full">
                        <a href="https://x.com/lunabetis" target="_blank" rel="noreferrer" className="group relative p-[1px] bg-gradient-border-btn rounded-xl w-full sm:w-[236px] hover:brightness-125 transition-[filter] cursor-pointer">
                            <div className="flex bg-gradient-color rounded-xl">
                                ...
                                <div className="flex items-center w-full h-full gap-2.5 p-3 rounded-[11px] overflow-hidden relative">
                        ...
                        <a href="https://discord.gg/yTQpvNwE" target="_blank" rel="noreferrer" className="group relative p-[1px] bg-gradient-border-btn rounded-xl w-full sm:w-[236px] hover:brightness-125 transition-[filter] cursor-pointer">
                            <div className="flex bg-gradient-color rounded-xl">
                                <div className="absolute rounded-lg -top-1.5 -right-3 z-[3] rotate-3 p-[1px] group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:rotate-6 transition-transform duration-300 ease-[cubic-bezier(.17,1.66,.68,1.01)] bg-green-shine">
                ...
                <div className="flex lg:flex-row gap-3 flex-col-reverse items-center justify-between mt-[42px] max-w-[1064px] mx-auto w-full">
                    <p className="text-sm text-center text-light-grey mr-2">© {new Date().getFullYear()} SolBet — Powered by Solana. All rights reserved.</p>
                    <LanguageDropdown />
                </div>
            </div>
        </div>
