...
const Sidebar = () => {
  ...
  return (
    <div className="flex w-fit h-full z-10">
      <div className={`xl:flex xl:flex-col fixed left-0 top-[70px] lg:top-[110px] w-[350px] lg:w-[300px] 2xl:w-[350px] h-[calc(100%-70px)] lg:h-[calc(100%-110px)] bg-[#0f0f23] border-r border-[#1D1D1D] transition-transform duration-300 will-change-transform hidden`}>
        <div className="absolute w-full px-6 py-4 bg-[#0f0f23fb] top-0 left-0 z-[10] grow-0 shrink-0 animate-fade-in">
          <div className="flex gap-2 mb-3">
            <button className="group flex items-center relative h-10 min-w-10 overflow-hidden transition duration-300 px-4 w-full bg-[#161635] hover:bg-[#161635]/75 text-sm font-medium text-white rounded-lg border border-[#3B3B3B] justify-between cursor-pointer">
              ...
              <div className="flex gap-1.5 items-center">
                <div className="w-max h-max bg-[#5B2CBF]/40 p-1 rounded-full">
                  <div className=" w-1.5 h-1.5 bg-[#5B2CBF] rounded-full">
                  </div>
                </div>
            ...
            <button
              className="group flex items-center justify-center relative h-10 min-w-10 overflow-hidden transition duration-300 bg-[#161635] hover:bg-[#161635]/75 text-sm font-medium text-white rounded-lg w-max px-0 border border-[#3B3B3B] cursor-pointer"
            ...
            <div className="flex items-center justify-between transition-[transform,opacity] duration-700 w-full">
              <div>
                ...
                <div className="relative text-xl leading-[20px] 2xl:text-[24px] 2xl:leading-[24px]">
                  ...
                  <span className="uppercase font-black bg-[#8567FF] whitespace-nowrap text-[#00000000] bg-clip-text">Airdrop</span>
                </div>
              </div>
          ...
          <div className="absolute bg-gradient-to-b from-[#0f0f23] to-[#0f0f23]/0 w-full translate-y-[40px] bottom-0 left-0 h-[40px]"></div>
        </div>
        <Chat />
        <SendChat />
      </div>
