            ...
            <div className="w-full h-full shadow-bet rounded-[13px] bg-gradient-to-b from-[#2E2E35]/85 to-[#1A1A22]/85 p-[3px] relative overflow-hidden">
                ...
                <svg width="9" height="66" viewBox="0 0 9 66" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute right-0 inset-y-0 m-auto pointer-events-none">
                    <g filter="url(#filter0_d_1614_8849)">
                        ...
                        <path d="M4.2 8.52179C4.2 7.87634 4.5456 7.28029 5.10577 6.95963L8.8 4.84494L8.8 61.1551L5.10577 59.0404C4.5456 58.7197 4.2 58.1237 4.2 57.4782L4.2 8.52179Z" stroke="url(#paint1_linear_1614_8849)" strokeOpacity="0.5" strokeWidth="0.4"></path>
                    </g>
                    ...
                    <defs>
                        <filter id="filter0_d_1614_8849" x="0" y="0.5" width="13" height="65" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                        ...
                        <filter id="filter1_f_1614_8849" x="3" y="7.13896" width="7" height="51.7221" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                            <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
                        ...
                        <linearGradient id="paint0_linear_1614_8849" x1="6.5" y1="4.5" x2="6.5" y2="61.5" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#6741FF"></stop><stop offset="1" stopColor="#CB4EE8"></stop>
                        </linearGradient>
                        <linearGradient id="paint1_linear_1614_8849" x1="9" y1="33" x2="4" y2="33" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#CB4EE8" stopOpacity="0"></stop><stop offset="1" stopColor="#CB4EE8" stopOpacity="0.56"></stop>
                        </linearGradient>
