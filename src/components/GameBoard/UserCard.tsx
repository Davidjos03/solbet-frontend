...
const UserCard: React.FC<{ player: IPlayer }> = ({ player }) => {
    const { totalBetAmount, solPrice, setSelectedUser, setIsProfileModal } = useUserProvider()
            ...
            >
                ...
                >
                    ...
                    <div className="text-right">
                        ...
                        <p className="font-inter font-bold text-xl text-white">{(player.price * 100 / totalBetAmount).toFixed(2)}%</p>
                    </div>
                </div>
                <div
