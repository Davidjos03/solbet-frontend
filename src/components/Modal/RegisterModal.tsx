                    ...
                    <div className="relative w-full h-full rounded-2xl bg-layer">
                        <div className="flex flex-col sm:flex-row">
                            ...
                            <div className="p-8 sm:w-[385px]">
                                ...
                                <Input label="Enter name" state={username} placeholder="your name" setState={setUsername} />
                                <Input label="Enter Email" state={email} placeholder="your@gmail.com" setState={setEmail} />
                                <Input label="Referral Code" state={referral} placeholder="optional" setState={setReferral} />
